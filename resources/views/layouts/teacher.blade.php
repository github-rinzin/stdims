...
<head>
    ...
    <title>classasset/teacher</title>
...
<body>
    ...
    <script src="{{ asset('asset/teacher/assets/js/jquery.min.js') }}"></script>
    <script src="{{ asset('asset/teacher/assets/bootstrap/js/bootstrap.min.js') }}"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-easing/1.4.1/jquery.easing.js"></script>
    <script src="{{ asset('asset/teacher/assets/js/theme.js') }}"></script>
</body>
