...
<div class="container-fluid w-75">
    ...
    <div class="card shadow">
        <div class="card-header d-flex flex justify-content-end p-0 pt-3 pr-3">
            <div class="card-header m-0 p-0 border-0"><a class="p-0" href="statement-create.html"><button class="btn btn-sm btn-primary m-0 mb-2" type="button"><i class="fas fa-pen-nib"></i>&nbsp;Write</button></a></div>
        </div>
        <div class="card-body">
