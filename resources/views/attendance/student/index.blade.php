        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item" role="presentation"><a class="nav-link active" href="student-attendance.html"><i class="fas fa-table"></i><span>Attendance</span></a><a class="nav-link" href="statement-index.html"><i class="fas fa-table"></i><span>Statement</span></a><a class="nav-link"
                            href="student-result.html"><i class="fas fa-table"></i><span>Result</span></a><a class="nav-link" href="join-class-create.html"><i class="fas fa-plus"></i><span>Join Class</span></a>
                    </li>
                </ul>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">Attendance</h3><a class="bg-light" href="#"></a>
                    </div>
                </div>
                <div class="container-fluid">
