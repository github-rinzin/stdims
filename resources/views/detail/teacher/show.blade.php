        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item" role="presentation"></li>
                    <li class="nav-item" role="presentation"><a class="nav-link" href="#"><i class="fa fa-id-card-o"></i><span>Student's Statement</span></a><a class="nav-link" href="#"><i class="fas fa-signal"></i><span>Result Management</span></a></li>
                </ul>
            ...
            <div id="content-1">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">Student&nbsp;</h3><a href="student-details-edit.html"><button class="btn" type="button">Edit&nbsp;<i class="far fa-edit"></i></button></a><a href="student-details-index.html"><button class="btn ml-auto" type="button"><i class="fa fa-long-arrow-left"></i>&nbsp;Back&nbsp;</button></a></div>
                    <div
                        class="card">
                        <div class="card-body">
                            <div class="card-body">
